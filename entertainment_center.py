...
real_steel = media.Movie("Real Steel",
                         ...
                         "A struggling promoter feels he's found a champion in a discarded robot.",
                         "http://www.impawards.com/2011/posters/real_steel_ver4.jpg",
...
finding_nemo = media.Movie("Finding Nemo",
                           ...
                           "http://vignette1.wikia.nocookie.net/disney/images/8/89/Finding_Nemo_-_Poster.jpg",
                           "https://www.youtube.com/watch?v=wZdpNglLbt8")

ip_man = media.Movie("Ip Man",
                     "During the Japanese invasion of 1937, when a wealthy martial artist is forced "
                     "to leave his home and work to support his family, "
                     "he reluctantly agrees to train others in the art of Wing Chun for self-defense.",
                     "http://img.goldposter.com/2015/05/Yip-Man_poster_goldposter_com_16.jpg",
                     "https://www.youtube.com/watch?v=1AJxXQ7xojE")

devil_wears_prada = media.Movie("The Devil Wears Prada",
                                "A smart but sensible new graduate lands a job as an assistant "
                                "to Miranda Priestly, the demanding editor-in-chief of a high fashion magazine.",
...
pirates = media.Movie("Pirates of the Carribean",
                      ...
                      "to save his love, the governor's daughter, "
                      "from Jack's former pirate allies, who are now undead.", 
                      "http://cdn.traileraddict.com/content/walt-disney-pictures/pirates.jpg",
